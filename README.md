...
Установите Docker Destop, потом при запущенном Docker зайдите консолью в корень каталога нашего проекта messenger. Чтобы быстро это сделать ПКМ + Shift по папке и выберите пункт открыть в терминале.
